...
public class AvionskaKompanijaControllerTest {
	...
	private static final String URL_PREFIX = "/avionske-kompanije";
	...
	@Test
	public void testVratiSveAvionskeKompanije() throws Exception {
	...
	@Test
	public void testVratiJednuAvionskuKompaniju() throws Exception {
	...
	@Transactional
	@Rollback(true)
	public void testKreirajAvionskuKompaniju() throws Exception {
		...
		AvionskaKompanijaDTO avionskaKompanijaDTO = new AvionskaKompanijaDTO();
		avionskaKompanijaDTO.setNaziv("naziv");
		avionskaKompanijaDTO.setAdresaDTO(adresaDTO);
		avionskaKompanijaDTO.setOpis("opis");

		String json = TestUtil.json(avionskaKompanijaDTO);
	...
	@Transactional
	@Rollback(true)
	public void testAzurirajAvionskuKompaniju() throws Exception {
		AdresaDTO adresaDTO = new AdresaDTO();
		adresaDTO.setId(1);
		adresaDTO.setUlica("ulica");
		adresaDTO.setGrad("grad");
	...
	@Transactional
	@Rollback(true)
	public void testObrisiAvionskuKompaniju() throws Exception {
