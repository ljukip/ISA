...
@Component({
  selector: 'app-izvestaj-poslovanja-vozilo',
  templateUrl: './izvestaj-poslovanja-vozilo.component.html',
  styleUrls: ['./izvestaj-poslovanja-vozilo.component.css']
})
export class IzvestajPoslovanjaVoziloComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute,  private authService: AuthService, 
    private rentacarService: KompanijaVozilaService) {
  }
  ...
  prikaziPrihod(){
    if(this.pocetniDatum !== undefined && this.krajnjiDatum !== undefined){
      ...
      this.rentacarService.prihodServisa(pocetni, krajnji, this.id).subscribe(
        s => 
        {
          this.prihod = s;
        }
  ...
  izvestajPoslovanja(){
    if(this.pocetniDatum !== undefined && this.krajnjiDatum !== undefined){
      ...
      this.labels = [];
      this.data = [];
      this.rentacarService.posecenostServisa(this.id, pocetni, krajnji).subscribe(
        s => {
          this.posecenost = s;
