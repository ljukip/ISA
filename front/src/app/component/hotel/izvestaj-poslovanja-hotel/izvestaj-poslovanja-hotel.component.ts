...
@Component({
  selector: 'app-izvestaj-poslovanja-hotel',
  templateUrl: './izvestaj-poslovanja-hotel.component.html',
  styleUrls: ['./izvestaj-poslovanja-hotel.component.css']
})
export class IzvestajPoslovanjaHotelComponent implements OnInit {
  ...
  prikaziPrihod(){
    if(this.pocetniDatum !== undefined && this.krajnjiDatum !== undefined){
      ...
      this.hotelService.prihodServisa(pocetni, krajnji, this.id).subscribe(
        s => 
        {
          this.prihod = s;
        }
  ...
  izvestajPoslovanja(){
    if(this.pocetniDatum !== undefined && this.krajnjiDatum !== undefined){
      ...
      this.labels = [];
      this.data = [];
      this.hotelService.posecenostServisa(this.id, pocetni, krajnji).subscribe(
        s => {
          this.posecenost = s;
